...
<template>
  <div :class="openModal ?
    ...
    'hidden'"
  >
    <input class="bg-gray-600 text-2xl p-3 rounded-[3px] outline-0 focus:border-2 border-blue-600" v-model="listName" type="text" placeholder="Digite o nome da lista">
